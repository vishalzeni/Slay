...
const AccountDialog = ({
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Get token from localStorage or user.accessToken
      const token =
        user.accessToken || JSON.parse(localStorage.getItem("user"))?.accessToken;
      ...
      if (typeof setUser === "function") {
        setUser(updated);
        // Optionally sync with localStorage if your app uses it
